export interface Photo { originalSrc?: string; src: string; placeholder: string; aspectRatio: number; shotNumber?: string; shotType?: string; description?: string; hasEmbeddedSidebar?: boolean; }
export interface Series { id: string; title: string; year: string; essay: string; images: Photo[]; }
export interface PrintProduct { id: string; title: string; year: string; type: string; paper: string; price: number; image: string; placeholder: string; sizes: string[]; inStock: boolean; }
export interface PortfolioData { series: Series[]; shop: PrintProduct[]; about: { bioParagraphs: string[]; email: string; instagram: string; cvUrl: string; sideProjects: { title: string; url: string }[]; }; }
export const portfolioData: PortfolioData = {
    ...
    "about":  {
                  ...
                  "bioParagraphs":  [
                                        "Ngo Thanh Sinh is a contemporary photographer."
                                    ],
